...
- Documenta cada paso en `docs/MEMORIA.md` (puedes usar el formato que prefieras).
- Incluye capturas de:
  - Ejecución de los scripts.
  - Salida del validador XML externo (éxito y error esperado).
  - Inserción válida e intento fallido en Oracle.
- Referencia la documentación consultada (Oracle, SQL/XML, validadores en línea, etc.).

## Tareas adicionales sugeridas

- Personalizar el XSD si decides ampliar los datos recuperados.
- Adaptar los scripts para generar varios ficheros XML filtrados (por departamento, rango salarial, etc.).
- Automatizar pruebas ejecutando los scripts desde un contenedor auxiliar o un pipeline CI.
